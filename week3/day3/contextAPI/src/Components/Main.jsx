export default function Main() {
  return (
    <p style={{textAlign:"justify"}}>
      ...
      the like). <br /><br />Where does it come from? Contrary to popular belief, Lorem
      ...
      line in section 1.10.32. The standard chunk of Lorem Ipsum used since 1966
      ...
      don't look even slightly believable.br <br /> <br /> If you are going to use a passage of
